...
function task3() {
  // Code here
  try {
    throw new error("something is wrong with you!")
  } catch (error){
...
function task4() {
  ...
  try {
    ...
    throw new error("Outside error message")
  } catch (outererror) {
...
task6({firstName: "Puja"}, "firstName");
...
task7("{'name': 'Puja'}"); //valid json
task7("{name: 'Puja}"); //invalid json
