...
function myAlphabetLength(){
    ...
    if (myAlphabet.length < 5 ){
        console.log("The length of myAlphabet: 7" );
    }   else {
...
planets.forEach((element)=> console.log("Planet: " + element + ", " + "Index" + ": " + planets.indexOf(element)))
...
*/
// Write your code here
wowDatatypes.forEach((element) => console.log("Item: " + element + ", " + "Index: " + wowDatatypes.indexOf(element) + ", " + "Type: "  + typeof element));
...
*/
// Write your code here
student1Courses.forEach((subject)=> {
    if (student2Courses.includes(subject)) {
        console.log("Common course: " + subject);
    }
})
...
*/
// Write your code here
furniture.forEach((item)=> console.log("Letters in " + item + ": " + item.split("")));
...
function getPositiveTemperatures(){
    let positiveTemp = [];
    temperatures.forEach((numb) =>{
        if (numb > 0){
            positiveTemp = positiveTemp.concat(numb)
        } 
    })
